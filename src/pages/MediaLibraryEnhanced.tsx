      ...
      <div className="min-h-screen bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="mb-8 bg-white rounded-lg border border-neutral-200 p-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-medium">
                  Upload Queue ({stats.uploading} uploading, {stats.completed} completed,{' '}
                  {stats.failed} failed)
                </h3>
                <button
          ...
          <div className="mb-4 text-xs text-neutral-500">
            <kbd className="px-1.5 py-0.5 bg-neutral-100 border border-neutral-300 rounded">
              Ctrl+A
            </kbd>{' '}
            Select all •{' '}
            <kbd className="px-1.5 py-0.5 bg-neutral-100 border border-neutral-300 rounded">
                    ...
                    {file.metadata?.tags && file.metadata.tags.length > 0 && (
                      <div className="flex gap-1 mt-2 flex-wrap">
                        {file.metadata.tags.slice(0, 3).map((tag: string) => (
                          <span
                            key={tag}
                            className="px-1.5 py-0.5 text-xs bg-brand/10 text-brand rounded"
                          >
                            {tag}
                          </span>
                        ))}
                    ...
                    <tr key={file.id} className="hover:bg-neutral-50">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-neutral-900 max-w-xs truncate">
                            {file.name}
                          </span>
                        </div>
                      </td>
