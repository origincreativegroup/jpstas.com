          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-brand-light max-w-2xl mx-auto">
                Explore detailed case studies and project breakdowns showcasing the full creative process.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
              <div className="flex items-center space-x-2">
                ...
                {['all', 'featured', 'e-commerce', 'design', 'development', 'process'].map((filter) => (
                  <button
                    key={filter}
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-warm max-w-2xl mx-auto">
              Explore my creative laboratory - a collection of tools, processes, and innovations.
            </p>
          </div>
              ...
              <div className="flex-1 max-w-md">
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-neutral-warm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center bg-accent/10 rounded-lg p-1">
                  <button
                    ...
                    className={`p-2 rounded-md transition-colors ${
                      viewMode === 'grid' ? 'bg-white shadow-sm text-brand' : 'text-accent hover:text-accent-dark'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded-md transition-colors ${
                      viewMode === 'list' ? 'bg-white shadow-sm text-brand' : 'text-accent hover:text-accent-dark'
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-4">
              <div className="flex items-center space-x-2 overflow-x-auto">
                {categories.map((category) => (
                  ...
                  >
                    {category === 'all' ? 'All Sections' : category.charAt(0).toUpperCase() + category.slice(1)}
                  </button>
                ))}
              </div>
            </div>
          ...
          {filteredSections.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-accent/70">
                {searchQuery ? 'Try adjusting your search terms' : 'No sections match the selected category'}
              </p>
            </div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-brand-light mb-6 max-w-md">
                Creative technologist building the future through design, development, and innovation.
              </p>
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/johnpstas" className="text-brand-light hover:text-accent transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://github.com/johnpstas" className="text-brand-light hover:text-accent transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-brand-light">
                <li><Link to="/workshop" className="hover:text-accent transition-colors">Design Bench</Link></li>
                <li><Link to="/workshop" className="hover:text-accent transition-colors">Development Desk</Link></li>
                <li><Link to="/workshop" className="hover:text-accent transition-colors">Innovation Bay</Link></li>
                <li><Link to="/workshop" className="hover:text-accent transition-colors">Story Forge</Link></li>
              </ul>
            </div>
          </div>
