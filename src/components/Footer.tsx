        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="md:col-span-2">
            <div class="flex items-center space-x-3 mb-6">
              ...
              <span class="text-2xl font-bold">John P. Stas</span>
            </div>
          ...
          {/* Navigation Links */}
          <div>
            <h4 class="text-lg font-semibold mb-6 text-white">Navigation</h4>
            <ul class="space-y-3">
              <li>
                <Link href="/about" class="text-white/70 hover:text-white transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link href="/portfolio" class="text-white/70 hover:text-white transition-colors">
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="/resume" class="text-white/70 hover:text-white transition-colors">
                  Resume
                </Link>
              </li>
              <li>
                <Link href="/contact" class="text-white/70 hover:text-white transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul class="space-y-3">
              ...
              <li>
                <span class="text-white/70">Process Innovation</span>
              </li>
              <li>
                <span class="text-white/70">Consulting</span>
              </li>
            </ul>
          </div>
        </div>
