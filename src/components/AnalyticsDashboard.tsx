          ...
          <div className="bg-white rounded-lg border border-neutral-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-neutral-900">{currentAnalytics.views.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-neutral-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-neutral-900">{currentAnalytics.likes.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-neutral-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-neutral-900">{currentAnalytics.shares.toLocaleString()}</p>
              </div>
            ...
            <div className="space-y-3">
              {topProjects.map((data, index) => (
                <div key={data.projectId} className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-neutral-600">{data.analytics.views} views</span>
                </div>
              ))}
            </div>
          </div>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-neutral-900">
                    {activity.type === 'view' ? 'Viewed' : 
                     ...
                     'Interacted with'} Project {activity.projectId}
                  </p>
