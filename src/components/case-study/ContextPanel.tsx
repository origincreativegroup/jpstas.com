  ...
  return (
    <section class="relative overflow-hidden rounded-3xl bg-white shadow-xl p-8 lg:p-12">
      <div class="relative z-10">
        ...
        <div class="mb-8">
          <div class="flex items-start gap-4 mb-6">
            <div class="relative group">
              <div class="w-14 h-14 bg-highlight rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-all duration-300 shadow-lg">
        ...
        {data.context.constraints && data.context.constraints.length > 0 && (
          <div class="mt-10">
            <h3 class="text-xl font-bold text-charcoal mb-6 flex items-center gap-3">
              <div class="w-2 h-8 bg-highlight rounded-full" />
              Key Constraints
            </h3>
            <div class="grid sm:grid-cols-2 gap-4">
              {data.context.constraints.map((c, index) => (
                <div
                  key={c}
                  class="group relative overflow-hidden rounded-2xl bg-white p-6 border border-neutral/20 hover:border-highlight/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        ...
        {data.context.quote && (
          <blockquote class="mt-10 relative rounded-2xl bg-primary/5 p-8 lg:p-10 border-l-4 border-primary">
            <div class="flex items-start gap-4">
