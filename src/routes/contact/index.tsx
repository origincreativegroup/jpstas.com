            ...
            <div class="rounded-3xl glass p-8 lg:p-10 h-full">
              ...
              <div class="space-y-6">
                ...
                <div class="group flex items-start gap-4 p-4 rounded-xl hover:bg-secondary/5 transition-all duration-300">
                  <div class="w-12 h-12 bg-secondary/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                ...
                <div class="group flex items-start gap-4 p-4 rounded-xl hover:bg-charcoal/5 transition-all duration-300">
                  <div class="w-12 h-12 bg-charcoal/20 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
              ...
              <div class="mt-10 p-6 bg-primary/10 rounded-2xl border border-primary/20">
          ...
          <div class="scroll-reveal" style="animation-delay: 100ms">
            {submitted.value ? (
              <div class="rounded-3xl glass p-8 lg:p-12 text-center h-full flex flex-col items-center justify-center">
                <div class="w-20 h-20 bg-secondary rounded-full flex items-center justify-center mb-6 animate-scaleIn">
              ...
              <div class="rounded-3xl glass p-8 lg:p-10">
                ...
                >
                  ...
                  <button
                    ...
                    class="group w-full px-8 py-4 bg-primary text-white rounded-xl hover:shadow-glow-lg transition-all duration-300 text-lg font-semibold transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                  >
                    {isSubmitting.value ? (
                      <>
