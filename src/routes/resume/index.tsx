      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-16">
          ...
          <div class="mt-8 flex flex-wrap gap-6 text-text-primary">
            <span class="flex items-center gap-2">
              ...
              <span class="text-text-secondary font-medium">johnpstas@gmail.com</span>
            </span>
            <span class="flex items-center gap-2">
              ...
              <span class="text-text-secondary font-medium">linkedin.com/in/john-stas-22b01054</span>
            </span>
            <span class="flex items-center gap-2">
              ...
              <span class="text-text-secondary font-medium">github.com/origincreativegroup</span>
            </span>
          </div>
        </section>
        ...
        <section class="rounded-3xl glass p-8 lg:p-10 mb-8">
          <div class="flex items-center gap-3 mb-8">
            <div class="w-10 h-10 bg-highlight rounded-xl flex items-center justify-center">
              <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="text-center py-8">
          ...
          <a
            href="/contact"
            class="inline-block px-8 py-3 bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors font-semibold"
          >
            Get In Touch
          </a>
        </div>
